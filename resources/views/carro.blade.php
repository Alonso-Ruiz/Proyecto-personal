...
<body>
    <form>
        ...
        <ul>
            <div class="grid">
            <div>
            <li><h3 style="color: #4b4b4b"><strong>Nombre del Vendedor:</strong>Alonso Smith</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Producto:</strong>Lamborghini Murcielago</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Cantidad de Productos en venta:</strong>1</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Dirección:</strong>Av.Jamaica</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Fecha de publicacion:</strong>09/03/023</h3></li>
            </div>
            ...
            <li><h2 style="color: #4b4b4b"><strong>Precio: S/.</strong>2.000.000</h2></li>
            </div>
