...
<body>
    <form>
        ...
        <ul>
            <div class="grid">
            <div>
            <li><h3 style="color: #4b4b4b"><strong>Nombre del Vendedor:</strong>Javier Santamaria</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Producto:</strong>Sansumg Galaxy K40</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Cantidad de Productos en venta:</strong>1</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Dirección:</strong>Jr.Baltazar Grados</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Fecha de publicacion:</strong>09/06/23</h3></li>
            </div>
            <img src="img/celular-removebg-preview.png" alt="">
            </div>

            <div class="grid1">
            <li><h2 style="color: green"><strong><i class="fab fa-whatsapp fa-sm"> </i>Teléfono del vendedor:</strong>968088145</h2></li>
            <li><h2 style="color: #4b4b4b"><strong>Precio: S/.</strong>800</h2></li>
            </div>
