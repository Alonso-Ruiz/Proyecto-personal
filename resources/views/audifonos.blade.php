...
<head>
    ...
    <link rel="stylesheet" href="../css/RCompra1.css">
...
<body>
    <form>
        ...
        <ul>
            <div class="grid">
            <div>
            <li><h3 style="color: #4b4b4b"><strong>Nombre del Vendedor:</strong>Luis Camargo</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Producto:</strong>Audifonos Premium-Version 1</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Cantidad de Productos en venta:</strong>1</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Dirección:</strong>Av.Nicolas de Pierola</h3></li>
            <li><h3 style="color: #4b4b4b"><strong>Fecha de publicacion:</strong>03/03/23</h3></li>
            </div>
            <img src="img/bg1.png" alt="">
            </div>

            <div class="grid1">
            <li><h2 style="color: green"><strong><i class="fab fa-whatsapp fa-sm"> </i>Teléfono del vendedor:</strong>987321654</h2></li>
            <li><h2 style="color: #4b4b4b"><strong>Precio: S/.</strong>199</h2></li>
            </div>
